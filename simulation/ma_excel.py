...
def set_widths(pair,writer): #to increase the column widths
...
def prepare_data(df_ma_res,df_ma_trades):
    ...
    df_ma_trades['time'] = [x.replace(tzinfo=None) for x in df_ma_trades['time']] #removing timezone as it crashes excel
